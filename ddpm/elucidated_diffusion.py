...
class ElucidatedDiffusion(nn.Module):
    ...
    def preconditioned_network_forward(self, noised_images, sigma, self_cond = None, embedded_cond = None, clamp = False):
    ...
    def sample(self, batch_size = 16, num_sample_steps = None, condition=None, lt_cond=None, clamp = False):
        ...
        for sigma, sigma_next, gamma in tqdm(sigmas_and_gammas, desc = 'sampling time step'):
            ...
            if sigma_next != 0:
                ...
                model_output_next = self.preconditioned_network_forward(images_next, sigma_next, self_cond, cond_emb, clamp = clamp)
