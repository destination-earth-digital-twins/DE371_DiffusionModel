...
class Ddpm_base:
    ...
    def _sample_batch(self, nb_img=4, condition=None,  lt_cond=None, ensemble_mean=None, sampling_noise=None):
        """
        ...
        if condition is None:
            ...
            sampled_images = self.model.sample(batch_size=nb_img, condition=condition, lt_cond=lt_cond, sampling_noise=sampling_noise)
